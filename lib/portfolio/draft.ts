...
가장 먼저 할 일은 이미지에서 읽히는 제목과 문구를 근거로
이 문서가 누구를 대상으로 무엇을 말하는 자료인지 파악하는 것입니다.
그 주제를 글 전체의 중심에 두고, 도입부와 소제목과 예시를 모두 그 주제에 맞춥니다.
문서의 주제를 밝히지 않은 채 디자인 일반론만 늘어놓은 글은 실패한 글입니다.
읽는 사람이 "이건 어떤 문서 이야기인지 알겠다"고 느껴야 합니다.

그 다음은 반드시 눈에 보이는 것만 근거로 쓰세요.
...
- 문서의 주제와 대상 독자는 밝히되, 의뢰한 회사가 어디인지는 밝히지 않습니다.

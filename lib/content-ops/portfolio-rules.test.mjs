...
test("blocks publication when blur verification or a required board is missing even with a partner override", () => {
  const metadata = portfolioMetadata("six_grid", [6, 6, 6], "blocked");
  metadata.partnerReleaseOverride = { approvedAt: "2026-08-10T00:00:00.000Z" };
